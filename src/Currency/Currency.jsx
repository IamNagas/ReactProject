            ...
            <div className="grid-container">
                ...
                <div className='grid-item2'>
                    ...
                    <div className='amountInput fromAmount'>
                        <input type="number" className='from-control border-0 rounded-0' 
                        value={fromAmount} onChange={e=>setfromAmount(e.target.value)}/>
                    </div>
                </div>
                <div className='grid-item3'>
                     <h2 className='fromto-title'> To Currency:</h2>
                     <CurrencyOption currencyOptions={CurrencyOptions} props="to currency"
                     updateHandler={e=>settoCurrency(e.terget.value)}/>
                     <p>
                         Enter Amount In:{currencyName[`${toCurrency}`]}
                     </p>
                         <div className="amountInput toAmount">
                            <input className='form-control border-0 rounded-0' type="number"  
                            value={toAmount} readOnly autoComplete='off' onChange={e=>settoAmount(e.target.value)}/>
                         </div>
